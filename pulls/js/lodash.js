...
(function () {
    ...
    function runInContext(context) {
        ...
        function createCaseFirst(methodName) {
            return function (string) {
                ...
                var chr = strSymbols ? strSymbols[0] : string.charAt(0),
                    trailing = strSymbols ? strSymbols.slice(1)
                    .join('') : string.slice(1);
        ...
        function createPadding(string, length, chars) {
            ...
            return reHasComplexSymbol.test(chars) ? stringToArray(result)
                .slice(0, padLength)
                .join('') : result.slice(0, padLength);
        }
        /**
         * Creates a function that wraps `func` to invoke it with the optional `this`
        ...
        function isNative(value) {
            ...
            return isObjectLike(value) && (isHostObject(value) ? reIsNative : reIsHostCtor)
                .test(value);
        }
        /**
        ...
        function random(lower, upper, floating) {
            ...
            if (floating || lower % 1 || upper % 1) {
                ...
                return nativeMin(lower + (rand * (upper - lower + freeParseFloat('1e-' + ((rand + '')
                    .length - 1)))), upper);
            }
        ...
        function template(string, options, guard) {
            ...
            var reDelimiters = RegExp(
                ...
                .source + '|' + interpolate.source + '|' + (interpolate === reInterpolate ? reEsTemplate : reNoMatch)
            ...
            string.replace(reDelimiters, function (match, escapeValue, interpolateValue, esTemplateValue, evaluateValue, offset) {
                ...
                source += string.slice(index, offset)
        ...
        function trim(string, chars, guard) {
            ...
            return strSymbols.slice(charsStartIndex(strSymbols, chrSymbols), charsEndIndex(strSymbols, chrSymbols) + 1)
                .join('');
        }
        /**
        ...
        function trimEnd(string, chars, guard) {
            ...
            var strSymbols = stringToArray(string);
            return strSymbols.slice(0, charsEndIndex(strSymbols, stringToArray(chars)) + 1)
                .join('');
        }
        /**
        ...
        function trimStart(string, chars, guard) {
            ...
            var strSymbols = stringToArray(string);
            return strSymbols.slice(charsStartIndex(strSymbols, stringToArray(chars)))
                .join('');
        }
        /**
        ...
        function truncate(string, options) {
            ...
            var result = strSymbols ? strSymbols.slice(0, end)
                .join('') : string.slice(0, end);
        ...
        arrayEach(['drop', 'take'], function (methodName, index) {
            ...
            LazyWrapper.prototype[methodName + 'Right'] = function (n) {
                return this.reverse()[methodName](n)
                    .reverse();
            };
        });
        ...
        realNames[createHybridWrapper(undefined, BIND_KEY_FLAG)
            .name] = [{
            'name': 'wrapper',
            'func': undefined
        }];
